    ...
    <div class="auth-container">
        ...
        <form id="register-form" method="POST" action="be-logic/formhandler/auth.php">
            ...
            <div class="input-group">
                ...
                <div>
                    <input type="text" id="register-username" name="register-username" placeholder="JohnDoe" autocomplete="username" class="<?php echo isset($_SESSION['errors']['username']) ? 'error-input' : ''; ?>">
            ...
            <div class="input-group">
                ...
                <div>
                    <input type="text" id="register-email" name="register-email" placeholder="name@example.com" autocomplete="email" class="<?php echo isset($_SESSION['errors']['email']) ? 'error-input' : ''; ?>">
            ...
            <div class="input-group">
                ...
                <div>
                    <input type="password" id="register-password" name="register-password" autocomplete="new-password" class="<?php echo isset($_SESSION['errors']['password']) ? 'error-input' : ''; ?>">
            ...
            <div class="input-group">
                ...
                <div id="register-password-confirm-container">
                    <input type="password" id="register-password-confirm" name="register-password-confirm" autocomplete="new-password" class="<?php echo isset($_SESSION['errors']['password_confirm']) ? 'error-input' : ''; ?>">
