...
<main>
    <div class="profile-container">
        <div class="backnav">
            <a class="back-button" href="profile.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-left mr-2 h-4 w-4" __v0_r="0,3543,3557">
        ...
        <div class="section">
            ...
            <form action="be-logic/update_account.php" method="POST">
                ...
                <button type="submit" class="icon-button smt-bttn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-save h-4 w-4 mr-2" __v0_r="0,7010,7024">
